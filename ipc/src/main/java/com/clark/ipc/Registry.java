...
import com.clark.ipc.model.Parameters;
...
public class Registry {
    ...
    public Method getMethod(Class<?> clazz, String methodName, Object[] parameters) {
        Map<String, Method> methods =mMethods.get(clazz);
        ...
        for (int i = 1; i < parameters.length; i++) {
            sb.append(",").append(parameters[i].getClass().getName());
        }
        sb.append(")");
